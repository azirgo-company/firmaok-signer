...
export function InstallButton() {
  ...
  return (
    <>
      ...
      {showIos && (
        <Modal title="Instalar en iPhone / iPad" onClose={() => setShowIos(false)}>
          <ol className="flex flex-col gap-3 text-sm text-slate-600 dark:text-slate-300">
            <li className="flex items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1">
                Toca <Share className="h-4 w-4 text-brand-500" strokeWidth={2} /> Compartir en la
                barra de Safari.
              </span>
            </li>
            <li className="flex items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1">
                Elige <Plus className="h-4 w-4 text-brand-500" strokeWidth={2} /> «Añadir a pantalla
                de inicio».
              </span>
            </li>
            <li className="flex items-center gap-2">
              ...
              <span>Confirma «Añadir». La app quedará en tu pantalla de inicio.</span>
            </li>
          </ol>
        </Modal>
      )}
